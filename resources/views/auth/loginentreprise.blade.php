        ...
        <div class="row justify-content-center ">
            <div class="col-md-8">
                <div class="card rounded-3 border-2 border-primary">
                    ...
                    <div>
                        <h3 style="font-family: 'Gluten', cursive; text-align:center; color:#2B55CD; margin-top:20px">Bienvenue Entreprise!</h3>
                    </div>
                    <div style="width: 50%; height: 2px; margin-left:auto;margin-right:auto;margin-bottom:20; border: 2px solid #2B55CD;"></div>


                    <div class="card-body">
                        <form method="POST" action="{{ route('entreprise.login.home') }}">
                            @csrf
